...
let index (c : char) : int =
  raise (Failure "Unimplemented: Enigma.index")
...
let map_r_to_l (wiring : string) (top_letter : char) (input_pos : int) :
    int =
  raise (Failure "Unimplemented: Enigma.map_r_to_l")
...
let map_l_to_r (wiring : string) (top_letter : char) (input_pos : int) :
    int =
  raise (Failure "Unimplemented: Enigma.map_l_to_r")
...
let map_refl (wiring : string) (input_pos : int) : int =
  raise (Failure "Unimplemented: Enigma.map_refl")
...
let rec map_plug (plugs : (char * char) list) (c : char) =
  raise (Failure "Unimplemented: Enigma.map_plug")
